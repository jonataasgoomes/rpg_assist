                                                                  ...
                                                                  return InkWell(
                                                                    onTap: () {
                                                                      if ((adventureDoc["master"] ==
                                                                        ...
                                                                        Navigator.push(
                                                                            context,
                                                                            MaterialPageRoute(builder: (context) => CharacterView(adventureDoc, snapshot.data, user, playerSnapshot.data.documents[index])));
                                                                      }
                                                                    },
                                                                    child:
                                                                        Container(
                                                                          ...
                                                                          decoration:
                                                                            ...
                                                                            trailing: (adventureDoc["master"] == user["id"]) | (user["id"] == playerSnapshot.data.documents[index]["userId"])
                                                                                ? PopupMenuButton<String>(onSelected: (String choice) {
                                                                                    adventureModel.choiceActionAdventure(choice, adventureDoc["adventureId"], playerSnapshot.data.documents[index]["characterId"], playerSnapshot.data.documents[index]["userId"], adventureDoc["master"], this.context);
                                                                                  }, itemBuilder: (context) {
                                                                            ...
                                                                            subtitle:
                                                                                Text(
                                                                              snapshot.data["masterTitle"] != null ? snapshot.data["masterTitle"] : "",
                                                                              maxLines: 1,
                                                                              overflow: TextOverflow.ellipsis,
                                                                            ),
                                                                            isThreeLine:
