              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Visibility(
                      visible: adventureDoc["master"] == userLogged["id"],
                      child: Flexible(
                        flex: 0,
                        child: Center(
                          child: Card(
                            ...
                            child: InkWell(
                              splashColor: Color.fromARGB(255, 6, 223, 176),
                              onTap: () {
                      ...
                      child: FutureBuilder<QuerySnapshot>(
                          ...
                          builder: (context, characterSnapshot) {
                            switch (characterSnapshot.connectionState) {
                              ...
                              default:
                                if (characterSnapshot.data.documents.length ==
                                    0) {
                                  return Text(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: <
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    decoration:
                                                                      ...
                                                                      image:
                                                                        ...
                                                                        fit: BoxFit
                                                                            .fill,
                                                                        image: characterSnapshot.data.documents[index]["raceNumber"] ==
                                                                                404
                                                                ...
                                                                Text(
                                                                  characterSnapshot.data.documents[index]
                                                                              [
                                                                              "name"] ==
                                                                          ""
                                                                      ? "Unamed"
