...
class Combat extends StatefulWidget {
  ...
  final String sessionId, characterId;
  ...
  _CombatState createState() => _CombatState(
      adventureDoc, sessionId, characterId, userLogged, sessionStatus);
}
...
class _CombatState extends State<Combat> {
  ...
  final String sessionId, characterId;
  final int sessionStatus;
  final GlobalKey<ScaffoldState> _scaffoldKeyCombat =
      new GlobalKey<ScaffoldState>();

  _CombatState(this.adventureDoc, this.sessionId, this.characterId,
      this.userLogged, this.sessionStatus);
        ...
        children: <Widget>[
          ...
          SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                sessionStatus != 2
                    ? DiceRoll(adventureDoc, sessionId, characterId, userLogged)
                    : Container(),
                ScopedModelDescendant<AdventureModel>(
                  builder: (context, child, adventureModel) {
                    return StreamBuilder<QuerySnapshot>(
                      stream: adventureModel.rollsAdventure(
                                  ...
                                  return Dismissible(
                                    ...
                                    confirmDismiss: (direction) async {
                                      if (adventureDoc["master"] ==
                                            ...
                                            builder: (context) {
                                              return AlertDialog(
                                                title: Text("confirm delete"
                                                    .toUpperCase()),
                                                content: Text(
                                                    "Are you sure you wish to delete this result? this is irreversible! "),
                                                actions: <Widget>[
                                                  FlatButton(
                                                      onPressed: () =>
                                        ...
                                        if (result) {
                                          _scaffoldKeyCombat.currentState
                                    ...
                                    key: Key(
                                        rolls.data.documents[index].toString()),
                                    child: FutureBuilder<DocumentSnapshot>(
                                      future: adventureModel.playerCharacter(
                                          adventureDoc["adventureId"],
                                          rolls.data.documents[index]
                                              ["userId"]),
                                      builder: (context, playerDoc) {
                                        switch (playerDoc.connectionState) {
                                          ...
                                          case ConnectionState.done:
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: <
                                                                      ...
                                                                      rolls.data.documents[index]["timestamp"] !=
                                                                          ...
                                                                          .format(rolls.data.documents[index][
                                                                      "timestamp"])
                                                                          .toString())
                                                                          : Text(
                                                                          "Loading ..."),
                                            ...
                                            }else if(playerDoc.data["status"] == 1){
